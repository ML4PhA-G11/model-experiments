#!/usr/bin/env bash
# H100 MIG parity of job-gpu-mig-sbatch.sh (3/7 slice, 9 CPUs, 45-min backfill).
#
...
# sbatch --job-name=lbm-tf-gpu_mig_h100 \
#   --partition=gpu_mig \
#   --gpus=h100_3g.40gb:1 \
#   --cpus-per-task=9 \
#   --time=00:45:00 \
#   --output=jobs/logs/lbm-tf-gpu_mig_h100-%j.out \
#   --error=jobs/logs/lbm-tf-gpu_mig_h100-%j.err \
